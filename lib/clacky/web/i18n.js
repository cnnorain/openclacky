...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "sessions.modelSwitchModal.title": "Switch Session Model",      "sib.dir.tooltip":         "Click to change directory",
      ...
      "settings.tabs.models":     "Providers",
      "settings.tabs.ui":         "UI",
      "settings.tabs.general":    "General",
      "settings.tabs.update":     "Update",
      "settings.tabs.about":      "About",      "settings.about.version":   "Version",
      ...
      "settings.models.title":    "AI Providers",
      "settings.models.add":      "+ Add Provider",
      "settings.models.loading":  "Loading providers…",
      "settings.models.error":    "Failed to load: {{msg}}",
      "settings.models.empty":    "No providers configured. Click \"+ Add Provider\" to add one.",      "settings.models.badge.default": "Default",
      "settings.models.badge.lite":    "Lite",
      "settings.models.field.quicksetup": "Quick Setup",
      "settings.models.field.providerName": "Provider Name",
      "settings.models.field.model":      "Model",      "settings.models.field.baseurl":    "Base URL",
      ...
      "settings.models.modal.add":         "Add Provider",
      "settings.models.modal.edit":        "Edit Provider",      "settings.models.field.provider":    "Provider",
      "settings.models.provider.custom":   "Custom",
      "settings.models.unnamed":           "Unnamed Model",
      "settings.models.defaultSelector.label": "Default Model",
      "settings.models.defaultSelector.hint":  "Click to choose a provider, then select a model from /models.",
      "settings.models.defaultSelector.choose": "Choose default model",
      "settings.models.defaultSelector.modalTitle": "Select Default Model",
      "settings.models.defaultSelector.providers": "Providers",
      "settings.models.defaultSelector.models": "Models",
      "settings.models.loadingModels":     "Loading models…",
      "settings.models.noModels":          "No preset models available",
      "settings.models.test.ok":           "✓ Connected",      "settings.models.test.fail":         "✗ Test fail: {{msg}}",
      ...
      // ── Update ──
      "settings.update.versionCheck":      "Version Check",
      ...
      "settings.update.updateAvailable":   "Update available",
      "settings.update.checkForUpdate":    "Check for Updates",
      "settings.update.checking":          "Checking…",
      "settings.update.history":           "Update History",
      "settings.update.noHistory":         "No update history available",
      "settings.update.mergeConflicts":    "Merge Conflicts",
      "settings.update.noConflicts":       "No merge conflicts detected",
      "settings.update.conflictsFound":    "{{count}} conflict(s) found",
      "settings.update.settings":          "Update Settings",
      "settings.update.autoCheck":         "Automatically check for updates",
      "settings.update.autoBackup":        "Backup before update",
      "settings.update.mergeNotify":       "Notify on merge conflicts",
      "settings.update.actions":           "Update Actions",
      "settings.update.updateNow":         "Update Now",
      "settings.update.viewSnapshots":     "View Snapshots",
      "settings.update.clearSnapshots":    "Clear Old Snapshots",
      "settings.update.updating":          "Updating…",
      "settings.update.success":           "Update successful!",
      "settings.update.failed":            "Update failed",
      "settings.update.snapshotCleared":   "Snapshots cleared successfully",
      // ── Onboard ──
      ...
      "billing.clear":           "× Clear",
      "billing.clearConfirm":    "Delete all billing data? This cannot be undone.",
    },
    zh: {
      // ── Sidebar ──
      "sidebar.chat":     "会话",
      ...
      "sessions.modelSwitchModal.title": "切换会话模型",      "sib.dir.tooltip":         "点击切换工作目录",
      ...
      // ── Settings panel ──
      "settings.title":           "设置",
      "settings.tabs.models":     "供应商",
      "settings.tabs.ui":         "界面",
      "settings.tabs.general":    "通用",
      "settings.tabs.update":     "更新",
      "settings.tabs.about":      "关于",      "settings.about.version":   "版本",
      ...
      "settings.models.title":    "AI 供应商",
      "settings.models.add":      "+ 添加供应商",
      "settings.models.loading":  "加载供应商中…",
      "settings.models.error":    "加载失败：{{msg}}",
      "settings.models.empty":    "暂未配置供应商，点击「+ 添加供应商」添加。",      "settings.models.badge.default": "默认",
      "settings.models.badge.lite":    "轻量",
      "settings.models.field.quicksetup": "快速配置",
      "settings.models.field.providerName": "供应商名称",
      "settings.models.field.model":      "Model",      "settings.models.field.baseurl":    "Base URL",
      "settings.models.field.apikey":     "API Key",
      ...
      "settings.models.modal.add":         "添加供应商",
      "settings.models.modal.edit":        "编辑供应商",      "settings.models.field.provider":    "供应商",
      "settings.models.provider.custom":   "自定义",
      "settings.models.unnamed":           "未命名模型",
      "settings.models.defaultSelector.label": "默认模型",
      "settings.models.defaultSelector.hint":  "点击选择供应商，再从 /models 加载出的模型列表中选择。",
      "settings.models.defaultSelector.choose": "选择默认模型",
      "settings.models.defaultSelector.modalTitle": "选择默认模型",
      "settings.models.defaultSelector.providers": "供应商",
      "settings.models.defaultSelector.models": "模型",
      "settings.models.loadingModels":     "加载模型中…",
      "settings.models.noModels":          "暂无预设模型",
      "settings.models.test.ok":           "✓ 连接成功",      "settings.models.test.fail":         "✗ 测试失败：{{msg}}",
      ...
      // ── Update ──
      "settings.update.versionCheck":      "版本检查",
      "settings.update.currentVersion":    "当前版本",
      "settings.update.latestVersion":     "最新版本",
      "settings.update.upToDate":          "已是最新版本",
      "settings.update.updateAvailable":   "有新版本可用",
      "settings.update.checkForUpdate":    "检查更新",
      "settings.update.checking":          "检查中…",
      "settings.update.history":           "更新历史",
      "settings.update.noHistory":         "暂无更新历史",
      "settings.update.mergeConflicts":    "合并冲突",
      "settings.update.noConflicts":       "未检测到合并冲突",
      "settings.update.conflictsFound":    "发现 {{count}} 个冲突",
      "settings.update.settings":          "更新设置",
      "settings.update.autoCheck":         "自动检查更新",
      "settings.update.autoBackup":        "更新前备份",
      "settings.update.mergeNotify":       "合并冲突时通知",
      "settings.update.actions":           "更新操作",
      "settings.update.updateNow":         "立即更新",
      "settings.update.viewSnapshots":     "查看快照",
      "settings.update.clearSnapshots":    "清理旧快照",
      "settings.update.updating":          "更新中…",
      "settings.update.success":           "更新成功！",
      "settings.update.failed":            "更新失败",
      "settings.update.snapshotCleared":   "快照清理成功",
      // ── Onboard ──
      ...
      "billing.clear":           "× 清空",
      "billing.clearConfirm":    "确定清空所有账单数据？此操作不可撤销。",
    }  };
