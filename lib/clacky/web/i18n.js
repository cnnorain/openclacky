...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "mcp.prompt.add":           "Help me add a new MCP server. Use the mcp-manager skill.",
      "mcp.prompt.fix":           "Help me reconfigure the MCP server '{{name}}'. Use the mcp-manager skill.",
    ...
    zh: {
      ...
      "mcp.prompt.add":           "帮我添加一个 MCP 服务。请用 mcp-manager skill。",
      "mcp.prompt.fix":           "帮我重新配置 MCP 服务 '{{name}}'。请用 mcp-manager skill。",
