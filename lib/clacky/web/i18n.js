...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "sidebar.plugins":  "Plugin Management",
      ...
      "plugins.subtitle":           "Extend your assistant with custom tools, hooks, and commands",
      "plugins.loading":            "Loading plugins...",
      "plugins.empty":              "No plugins installed",
      "plugins.btn.reload":         "Refresh",
      "plugins.reloading":          "Refreshing...",
      ...
      "plugins.detail.error":       "Error",
      "plugins.detail.tools":       "Tools",
      "plugins.detail.hooks":       "Hooks",
      "plugins.detail.commands":    "Commands",
      "plugins.detail.path":        "Path",
      "plugins.detail.none":        "None",
      "plugins.settings":           "Settings",
      "plugins.settings.save":      "Save",
      "plugins.settings.saving":    "Saving...",
      "plugins.settings.empty":     "No configuration available",
      "plugins.settings.newKey":    "New key name",
      "plugins.settings.add":       "Add",
      "plugins.settings.delete":    "Delete",
      "plugins.settings.keyExists": "Key already exists",
      "plugins.settings.custom":    "Custom",
      ...
      "settings.models.field.name":        "Name",
    ...
    zh: {
      ...
      // ── Plugins panel ──
      "plugins.title":              "插件",
      "plugins.subtitle":           "通过自定义工具、钩子和命令扩展助手能力",
      "plugins.loading":            "加载插件中...",
      "plugins.empty":              "暂无已安装的插件",
      "plugins.btn.reload":         "刷新",
      "plugins.reloading":          "刷新中...",
      ...
      "plugins.detail.error":       "错误",
      "plugins.detail.tools":       "工具",
      "plugins.detail.hooks":       "钩子",
      "plugins.detail.commands":    "命令",
      "plugins.detail.path":        "路径",
      "plugins.detail.none":        "无",
      "plugins.settings":           "设置",
      "plugins.settings.save":      "保存",
      "plugins.settings.saving":    "保存中...",
      "plugins.settings.empty":     "暂无可配置项",
      "plugins.settings.newKey":    "新配置项名称",
      "plugins.settings.add":       "添加",
      "plugins.settings.delete":    "删除",
      "plugins.settings.keyExists": "配置项已存在",
      "plugins.settings.custom":    "自定义",
